...
class GetStockByBranchUseCase(
    private val stockRepository: StockRepository
) {

    suspend operator fun invoke(businessId: String, branchId: String): Result<List<Stock>> {
        ...
        return stockRepository.getStockByBranch(businessId, branchId)
    }
}
